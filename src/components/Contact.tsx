...
const nextSteps = [
  {
    step: "01",
    title: "Teknik Gorusme",
    desc: "Mevcut IT altyapisi, veri kaynaklari ve oncelikli sorunlarin detayli analizi.",
  },
  {
    step: "02",
    title: "Pilot Proje",
    desc: "Tek bir santral veya VEDAS bolgesinde AI ajan prototipi ile PoC (Proof of Concept).",
  },
  {
    step: "03",
    title: "Entegrasyon",
    desc: "SCADA, ERP ve mevcut sistemlere entegrasyon. Data pipeline kurulumu.",
  },
  {
    step: "04",
    title: "Olceklendirme",
    desc: "Basarili pilot sonrasi tum portfoye yaygin, 133 sirket icin birlesik platform.",
  },
];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-bold mt-3 tracking-tight">
            Birlikte{" "}
            <span className="text-gradient">Basaralim</span>
          </h2>
          <p className="text-foreground/50 mt-4 max-w-2xl mx-auto text-sm">
            526 MW&apos;dan 3,953 MW&apos;a uzanan buyume yolculugunda, AI tabanli
            operasyonel mukemmeliyet icin onerdigim yol haritasi.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-12">
          ...
          >
            ...
            <div className="font-medium text-sm group-hover:text-primary transition-colors">E-posta</div>
          ...
          >
            ...
            <div className="font-medium text-sm group-hover:text-primary transition-colors">GitHub</div>
          ...
          >
            ...
            <div className="font-medium text-sm group-hover:text-secondary transition-colors">LinkedIn</div>
            <div className="text-xs text-foreground/40 mt-1">Sedat Irtas</div>
          </motion.a>
        </div>
        ...
        >
          <p className="text-foreground/60 text-sm max-w-xl mx-auto mb-6">
            Bu portfolyo, Turkerler Holding&apos;in enerji operasyonlari icin
            ozel olarak hazirlanmistir. Tum teknik detaylar, mimari tasarim ve
            prototip kodlari incelemeye aciktir.
          </p>
